...
<style>
    ...
    .news-chat-quote__colour-host {
        color: #b8d9aa;
    }

    .news-chat-quote__colour-mint {
        color: #62df99;
    }

    .news-chat-quote__colour-mappers {
        color: #ba7ccc;
    }

    .news-chat-quote__colour-player {
        color: #FFFFFF;
    }

    .news-chat-quote__colour-mir {
        color: #62df99;
    }

        .news-chat-quote__colour-admin {
        color: #FFFFFF;
    }

        .news-chat-quote__colour-staff {
        color: #FFFFFF;
    }
...
This question does not apply to me I'm like the McDonalds of tech mapping BUT I don't think playable and memorable are mutually exclusive. It's just hard to make something good.
...
Yes it has, though I'd say it helped me understand the pooling process a little more and the scheduling of things but I wasn't involved enough to say I was "deeply enlightened" or anything!
...
I just hope people have fun playing my maps, that's enough for me.
...
<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12626424">Creepattack</a></p>

Hi im creepattack. I make osu maps, dm me to play apex legends.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/1499997" style="background-image: url('/wiki/shared/avatars/9ami.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/1499997">9ami</a></p>

Hi im nine ami. I make maps in osu and usually play some aim slop lmao.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12905443" style="background-image: url('/wiki/shared/avatars/Clubby.jpg')"></a>
...
<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/15664628">Arushii</a></p>

Hey my names arushiii and i've mapped for 12 owc back to back and i'm so ccool and amazing and i do such awesome artwork.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/20101640" style="background-image: url('/wiki/shared/avatars/Cocoyu.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/20101640">Cocoyu</a></p>

Hello I am Cocoyu, and I like to map sometimes.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/19607568" style="background-image: url('/wiki/shared/avatars/lela.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-host" href="https://osu.ppy.sh/users/19607568">lela</a></p>

From ltc1 to 3, how do you think your style of mapping has changed? Or has it not at all.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12626424" style="background-image: url('/wiki/shared/avatars/Creepattack.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12626424">Creepattack</a></p>

Going from ltc1 to 3 I'd say that my mapping style has become more expressive as the years passed, I originally was a mapper who mostly mapped simple generic anime maps and ltc1 was probably one of the first times I mapped tech. As I continued to custom map for tourneys, I began to get a better sense of how to express ideas in maps.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/1499997" style="background-image: url('/wiki/shared/avatars/9ami.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/1499997">9ami</a></p>

I think my style definitely changed a bit, I like trying new stuff and experimenting on every map.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12905443" style="background-image: url('/wiki/shared/avatars/Clubby.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12905443">Clubby</a></p>

I didn't map for LTC1 but between LTC2 and 3 my mapping didn't change too much, but I did become much more confident with my tech mapping which I think is obvious when analysing my parts in any capacity.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/15664628" style="background-image: url('/wiki/shared/avatars/Arushii.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/15664628">Arushii</a></p>

I can say my mapping style has completely changed quite a few times! Each gftb from ltc1 to 3 represents an iteration of my mapping style, you can tell there are still some level of similarity in the first and second tb, but this year's was totally different, since my mapping style has gradually changed to something more unique since the second half of 2025. Looking back to the first ltc gftb, I can still point out the parts I mapped based on my memories and some slider choices I made, yet shocked that I used to map like this!

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/20101640" style="background-image: url('/wiki/shared/avatars/Cocoyu.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/20101640">Cocoyu</a></p>

Ltc1 was 2 years ago and i think that my mapping has changed a lot since then. My mapping back then was still during my "improving stage" because at that time i was still kinda new to mapping and i never rlly was satisfied with any of the maps i finished. The style i always had was looping the song on repeat and just feeling what feels right with the song if that makes sense and it never changed. Currently I haven't been mapping a lot since im more focused on improving at other creative fields atm, but i can say that i have been liking a lot more of my recent maps.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/19607568" style="background-image: url('/wiki/shared/avatars/lela.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-host" href="https://osu.ppy.sh/users/19607568">lela</a></p>

Being that this was an 8 minute long tiebreaker, how did you prevent the map from feeling disconnected stylistically.
...
To be honest, I did not think too much about this XD, I just map based on how the song feels like for me, and luckily almost every beginning of my sections had a small pause that I don't have to think much about the pattern connection, athough I really liked how 9ami continued the style at 03:44:996 (1) -

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/20101640" style="background-image: url('/wiki/shared/avatars/Cocoyu.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/20101640">Cocoyu</a></p>

I think all of the tbs is really cool and I can't choose one to say is my favourite, but if i had to choose one it would be from the first ltc. The first tb I made was with 3 amazing mappers, that was my first time in a collab with more than 2 ppl in a map I think. So that's what made it special to me.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/19607568" style="background-image: url('/wiki/shared/avatars/lela.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-host" href="https://osu.ppy.sh/users/19607568">lela</a></p>

What tiebreaker was your favorite/ you felt the most proud of?

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12626424" style="background-image: url('/wiki/shared/avatars/Creepattack.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12626424">Creepattack</a></p>

In my opinion, the first tiebreaker we did works the best cohesively which is why its my favorite, I would say that ltc3 has better individual parts though.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/1499997" style="background-image: url('/wiki/shared/avatars/9ami.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/1499997">9ami</a></p>

I love every tiebreaker I made to be honest.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12905443" style="background-image: url('/wiki/shared/avatars/Clubby.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12905443">Clubby</a></p>

I'm definitely the most proud of my parts in MooN. It showcases a lot of my movement ideas while being the first time I've successfully mapped in a "tech style" without it looking like I'm larping lol.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/15664628" style="background-image: url('/wiki/shared/avatars/Arushii.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/15664628">Arushii</a></p>

Despite this year's gftb having the best quality overall, yet ltc2's gftb is my favorite. I do feel like we had a higher level of passion during the mapping process, and I actually liked what I mapped during that time. Not mentioning that I also made a draft for the bg, surely I am having more fun on ltc2. Not sure if the song was also a buff to this but it really gives me the vibe.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/20101640" style="background-image: url('/wiki/shared/avatars/Cocoyu.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/20101640">Cocoyu</a></p>

If there is another ltc sometime in the future i would be happy to be a part of it again. I didn't contribute that much to this years tb since i was busy and couldn't access the editor for the majority of the time making this tb thoough.
...
I like to think of each years tiebreaker influenced the next, each one was an improvement to the last.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12905443" style="background-image: url('/wiki/shared/avatars/Clubby.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12905443">Clubby</a></p>

Previous trauma of being the clearly worst mapper in the collab forced me to push myself and try my best.....

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/15664628" style="background-image: url('/wiki/shared/avatars/Arushii.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/15664628">Arushii</a></p>

Not really, I didnt come up with an idea for that since there is not much connections between the songs. It's funny tho because I didnt realized we are at the third iteration of this tournament already.
...
The maps atomosphere was inspired from the original custom, you can see lots of it in the storyboard.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/12905443" style="background-image: url('/wiki/shared/avatars/Clubby.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/12905443">Clubby</a></p>

I think the maps atmosphere is built heavily on the custom background we used as well as the storyboard. Looking through the map, especially the slider art, its obvious the shapes are conveying something ethereal, not from this world, grandiose and cosmic. The way the shapes feel like they come out of the screen and have a level of depth to them is so satisfying and elevates the experience of playing or even just watching the map in the editor.

<a class="avatar news-chat-quote__avatar" href="https://osu.ppy.sh/users/15664628" style="background-image: url('/wiki/shared/avatars/Arushii.jpg')"></a>

<p class="news-chat-quote__username"><a class="news-chat-quote__colour-tb-mapper" href="https://osu.ppy.sh/users/15664628">Arushii</a></p>

The most inspired/conceptual section I made for this map is definitely 02:54 ~ 03:44. Just like how the song title implies, I mainly used the moon as my concept, the most obvious one are 03:13:998 (1) - . There is also some traditional Chinese style instruments happening in the song so I came up with the idea of jellyfish 03:24:478 (1) -  and goldfish 03:44:297 (1) - sliders (I hope they are not too abstract).
